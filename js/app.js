...
function cargarInfo(e) {
    ...
    if (e.target.classList.contains('playPop')) {
        jsonurl = 'musicJSON/pop.json';
        titlePlay = 'Mejor playlist de la musica Pop!';
        descripcionPlay = 'La mejor playlist para eschuchar Pop';
        srcImg = 'img/Pop.jpg';
        album.style.background = "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(/img/Pop.jpg)";
    } else if (e.target.classList.contains('playRock')) {
        jsonurl = 'musicJSON/rock.json';
        titlePlay = 'Playlist para rockear';
        descripcionPlay = 'La mejor playlist para rockear';
        srcImg = 'img/Rock.jpg';
        album.style.background = "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(/img/Rock.jpg)";
    } else if (e.target.classList.contains('playRap')) {
        jsonurl = 'musicJSON/rap.json';
        titlePlay = 'Lo mejor del Rap';
        descripcionPlay = 'Playlist para rapear';
        srcImg = 'img/Rap.jpg';
        album.style.background = "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(/img/Rap.jpg)";
    }
